...
// ---------------  8.7 --------------------
$lng['users']['info']['sms_verification'] = 'Tu cuenta está inactiva. Recibirá pronto un mensaje SMS que contiene un código de verificación. Ingrese el código en el cuadro de abajo para activar su cuenta.';
$lng['users']['verification_code'] = 'Código de verificación';
$lng['users']['waiting_sms_activation'] = 'Esperando la activación de SMS';
$lng['listings']['info']['sms_verification'] = '¡Su anuncio está actualmente inactiva! Recibirá pronto un mensaje SMS que contiene un código de verificación. Introduzca el código en el cuadro de abajo para activar su anuncio.';
...
$lng['listings']['errors']['invalid_phone'] = '¡Numero de telefono invalido!';
...
$lng['invoice']['new_listing'] = 'Nuevo listado';
...
$lng['invoice']['store'] = 'Compra de Página del Comercio';
...
$lng['contact']['error']['phone_or_email_missing'] = 'Por favor ingrese su dirección de correo electrónico o número de teléno!';
$lng['general']['at'] = 'a';
$lng['general']['distance_from'] = 'de distancia de';
// --------------- end 9.3 --------------------

// --------------- 9.4 --------------------
$lng['contact']['error']['comments_forbidden_words'] = 'El mensaje contiene lenguaje prohibido, rev�salo!';
// --------------- end 9.4 --------------------

// --------------- 9.5 --------------------
$lng['ie']['added'] = 'sumado';
$lng['users']['repeat'] = 'Repite';
