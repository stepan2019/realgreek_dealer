...
$array_searches = array("id", "username", "email", "amount_from", "amount_to", "affiliate_id", "date_from", "date_to");
...
if($_POST) {
	...
	foreach($_POST as $key=>$value) {
		if(!preg_match('/^(rev)([0-9])+/',$key)) continue;
	...
	{
		$location="affiliates_revenue.php?page=".$page;
...
$smarty->display('affiliates_revenues.html');
