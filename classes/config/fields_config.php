...
class fields_config {
	...
	function check_form ($id='', $type='') {
		...
		$array_for_size = array("textbox", "textarea", "htmlarea", "url", "email", "youtube", "date", "multiselect", "phone", "whatsapp");
		...
		$array_validation = array ( "url" , "email" , "file" , "image" , "date", "youtube" );
		...
		if(($type=='image' || $type=='file') && !$_POST['max_uploaded_size']) {
	...
	function add() {
		...
		$this->clean['required'] = '';
		$this->clean['error_message'] = '';
		$this->clean['error_message2'] = '';
		$this->clean['info_message'] = '';
		$this->clean['unique'] = 0;
		$this->clean['ext1'] = 0;
		...
		if( ($this->clean['type']=="file" || $this->clean['type']=="image") && isset($_POST['max_uploaded_size'])) $this->clean['max_uploaded_size']=escape($_POST['max_uploaded_size']); else $this->clean['max_uploaded_size']='0';
		...
		if($this->clean['type']=="image" || $this->clean['type']=="file") {
